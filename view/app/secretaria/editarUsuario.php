                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" name="nombres" id="nombres" maxlength="10" class="form-control"  value="<?php echo $result[0][1] ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Apellidos</label>
                                                        <input type="text" name="apellidos" id="apellidos" maxlength="10" class="form-control" value="<?php echo $result[0][2] ?>"  />
                                                    </div>
                                                </div>
                                            </div>
